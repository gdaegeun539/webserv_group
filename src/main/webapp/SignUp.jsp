...
<div class="member">
    ...
    <div class="d-grid gap-2 col-6 mx-auto">
        <div class="form-floating mb-3">
            <input type="test" class="form-control" id="UserName" placeholder="이름">
    ...
    <!-- 2. 아이디, 비밀번호 -->
        ...
        <button type="submit" class="btn btn-dark mb-2">중복확인</button>
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control" id="UserPassRe" placeholder="비밀번호 재확인">
